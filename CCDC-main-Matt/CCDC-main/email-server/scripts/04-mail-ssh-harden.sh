#!/bin/bash
###############################################################################
# 04-mail-ssh-harden.sh - SSH Hardening for Mail Server
...
LOGFILE="/root/ccdc-logs/mail_ssh_harden_$(date +%Y%m%d_%H%M%S).log"
...
log "Starting SSH hardening for mail server..."
...
echo ""
echo "============================================"
echo "SSH HARDENING FOR MAIL SERVER"
echo "============================================"
...
# CCDC SSH Hardening Configuration - Mail Server
# Generated by 04-mail-ssh-harden.sh
...
if sshd -t 2>&1; then
    ...
    cp "$BACKUP_DIR/ssh/sshd_config" "$SSHD_CONFIG" 2>/dev/null || true
